...
import { B as Button } from './button-Cul2gyf-.mjs';
import { I as Input } from './input-DDl6Pfw1.mjs';
import { Label } from '@radix-ui/react-label';
import React__default, { useState, useMemo } from 'react';
import { toast } from 'sonner';
import { T as Textarea, S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem, C as Calendar, e as TanStackTable } from './calendar-Dh1ccXnm.mjs';
import { useQueryClient, useMutation, useQuery } from '@tanstack/react-query';
import { c as crawlSubPageLinks, u as uploadIntoRag, b as getScrapedFilesTable, d as deleteScrapedFileFromTable } from './ragServices-BTI_KB5q.mjs';
import { Globe, CalendarIcon, Search, Trash2 } from 'lucide-react';
...
function UrlsTable() {
  ...
  const { data, isPending } = useQuery({
    queryKey: ["scraped-files-list", page, limit, selectedWorkspace == null ? void 0 : selectedWorkspace.id],
    queryFn: async () => {
      const res = (selectedWorkspace == null ? void 0 : selectedWorkspace.id) ? await getScrapedFilesTable(
        `/files/upload/scraped?page=${page}&limit=${limit}&user_id=${selectedWorkspace == null ? void 0 : selectedWorkspace.id}`
      ...
      if ((res == null ? void 0 : res.status) === 200 || (res == null ? void 0 : res.status) === 201) {
        ...
        toast.error(
          (res == null ? void 0 : res.message) || "Something went wrong while fetching files..."
        );
      }
      return res;
    },
  ...
  const uploadScrapedLinksIntoRagMutation = useMutation({
    ...
    onError: (error) => {
      toast.error((error == null ? void 0 : error.message) || "Failed to upload links");
    }
  });
  const deleteScrapedFilesMutation = useMutation({
    ...
    onError: (error) => {
      toast.error((error == null ? void 0 : error.message) || `file deletion error...`);
    }
  });
  router.navigate({
    to: "/mainLayout/urls",
  ...
  const FilesData = useMemo(() => {
    var _a2;
    if (!((_a2 = data == null ? void 0 : data.data) == null ? void 0 : _a2.records)) return [];
    if (!Array.isArray(data.data.records)) return [];
    return data.data.records;
  }, [(_a = data == null ? void 0 : data.data) == null ? void 0 : _a.records]);
  const paginationInfo = (_b = data == null ? void 0 : data.data) == null ? void 0 : _b.paginationInfo;
...
function UrlsComponent() {
  ...
  const crawlLinksMutation = useMutation({
    ...
    onSuccess: (data) => {
      setScrapedLinks((prev) => [...prev, ...data == null ? void 0 : data.data.data.urls]);
      return data == null ? void 0 : data.data;
    },
    onError: (error) => {
      toast.error(
        (error == null ? void 0 : error.message) || `Scraping sub pages for this website failed..`
      );
    }
  });
  const uploadScrapedLinksIntoRagMutation = useMutation({
      ...
      scrapedLinks.length > 0 && /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "h-[200px] overflow-y-auto rounded-md bg-white shadow-sm", children: /* @__PURE__ */ jsx("ul", { className: "space-y-3 p-2", children: scrapedLinks.map((scrape, index) => /* @__PURE__ */ jsx(
          "li",
          {
            ...
            children: (scrape == null ? void 0 : scrape.flag) === true ? /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "checkbox",
              ...
              /* @__PURE__ */ jsx("div", { className: "flex flex-col max-w-full", children: /* @__PURE__ */ jsx(
                "a",
                {
                  href: (scrape == null ? void 0 : scrape.url) || "#",
                  className: "text-sm text-blue-600 hover:underline break-words max-w-full",
                  target: "_blank",
                  rel: "noreferrer",
                  children: (scrape == null ? void 0 : scrape.url) || "https://www.saletable.ai/product/reporting/"
                }
              ) })
...
//# sourceMappingURL=index-Cm99Xgit.mjs.map
