...
import { B as Button, $ as $fetch, c as cn } from './button-Cul2gyf-.mjs';
...
import { Check, CalendarIcon, Search, Trash2 } from 'lucide-react';
...
function FilesTableColumns({
  ...
  return [
      ...
      cell: (info) => {
        ...
        return /* @__PURE__ */ jsx(
          "span",
          {
            ...
            children: (_a = info.getValue()) != null ? _a : "..."
          }
        );
      },
      size: 200
      ...
      cell: (info) => {
        ...
        return /* @__PURE__ */ jsx(
          "span",
          {
            ...
            children: (_a = info.getValue().split("/").pop()) != null ? _a : "..."
          }
        );
      },
      size: 120
    ...
    },
    {
      ...
      cell: (info) => {
        var _a;
        const status = (_a = info.getValue()) != null ? _a : "UNKNOWN";
        return /* @__PURE__ */ jsx(
          "span",
          {
            style: {
    ...
    },
    {
      ...
      cell: (info) => {
        var _a;
        const value = (_a = info.getValue()) != null ? _a : "";
        if (!value)
          return /* @__PURE__ */ jsx(
            "span",
            {
...
function FilesTable() {
  ...
  const { data, isPending } = useQuery({
    queryKey: ["files-list", page, limit, selectedWorkspace == null ? void 0 : selectedWorkspace.id, date, search],
    queryFn: async () => {
      const baseUrl = (selectedWorkspace == null ? void 0 : selectedWorkspace.id) ? `/files/upload/manual?page=${page}&limit=${limit}&user_id=${selectedWorkspace == null ? void 0 : selectedWorkspace.id}` : `/files/upload/manual?page=${page}&limit=${limit}`;
      ...
      if ((res == null ? void 0 : res.status) === 200 || (res == null ? void 0 : res.status) === 201) {
        ...
        toast.error((res == null ? void 0 : res.message) || "Files list loading failed...");
      }
      return res;
    },
  ...
  const deleteManualFileMutation = useMutation({
    ...
    onError: (error) => {
      toast.error(`Failed to delete file: ${error == null ? void 0 : error.message}`);
    }
  });
  router.navigate({
    to: "/mainLayout/files",
  ...
  const FilesData = useMemo(() => {
    var _a2;
    if (!((_a2 = data == null ? void 0 : data.data) == null ? void 0 : _a2.records) || !Array.isArray(data.data.records)) return [];
  ...
  const uploadSignedUrl = useMutation({
    ...
    mutationFn: async (payload) => {
      ...
      if ((res == null ? void 0 : res.status) === 200 || (res == null ? void 0 : res.status) === 201) {
        ...
        toast.error((res == null ? void 0 : res.message) || "File upload failed");
      }
    }
  });
            ...
            children: [
              /* @__PURE__ */ jsx(
                Input,
                {
                  ...
                  onChange: (e) => {
                    var _a;
                    return handleFilesOnChange((_a = e.target.files) != null ? _a : []);
                  },
                  multiple: true
                }
              ),
          ...
          return /* @__PURE__ */ jsxs(
            "li",
            {
              ...
              children: [
                ...
                progress && /* @__PURE__ */ jsx(CircleProgress, { progress: progress == null ? void 0 : progress.progress })
              ]
            },
            index
          );
...
//# sourceMappingURL=index-CgvzSunL.mjs.map
