...
import { c as cn, b as buttonVariants, B as Button } from './button-Cul2gyf-.mjs';
...
import { ChevronDownIcon, CheckIcon, ChevronLeftIcon, ChevronRightIcon, ChevronUpIcon, MoreHorizontalIcon } from 'lucide-react';
...
const TanStackTable = ({
  ...
  const sortAndGetData = useCallback(
    (header) => {
      ...
      getData({
        ...searchParams,
        page: 1,
        limit: searchParams.get("limit") || (paginationDetails == null ? void 0 : paginationDetails.limit) || 15,
        order_by: orderBy
      });
    },
    [getData, searchParams, removeSortingForColumnIds, paginationDetails == null ? void 0 : paginationDetails.limit]
  );
  ...
  const getColumnStyle = useCallback(
    (headerId, index) => {
      const column = columns.find((col) => col.id === headerId);
      let baseStyle = {};
      if ((column == null ? void 0 : column.minWidth) && (column == null ? void 0 : column.maxWidth)) {
        baseStyle = {
          minWidth: `${column.minWidth}px`,
          maxWidth: `${column.maxWidth}px`,
          width: "auto"
        };
      } else if ((column == null ? void 0 : column.minWidth) || (column == null ? void 0 : column.maxWidth)) {
        baseStyle = {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "w-full rounded-md bg-white border border-gray-200", children: [
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: loading ? /* @__PURE__ */ jsx("div", { className: "w-full h-full flex flex-col", children: /* @__PURE__ */ jsxs("table", { className: "w-full border-collapse bg-white table-auto", children: [
          /* @__PURE__ */ jsx("thead", { children: table == null ? void 0 : table.getHeaderGroups().map((headerGroup) => /* @__PURE__ */ jsx("tr", { children: headerGroup.headers.map(
          ...
          /* @__PURE__ */ jsx("tbody", { children: [...Array((paginationDetails == null ? void 0 : paginationDetails.limit) || 15)].map((_, i) => /* @__PURE__ */ jsx(
            "tr",
            {
          ...
          /* @__PURE__ */ jsx("tbody", { children: (data == null ? void 0 : data.length) ? table == null ? void 0 : table.getRowModel().rows.map((row, index) => /* @__PURE__ */ jsx(
            "tr",
            {
    ...
    !loading && (data == null ? void 0 : data.length) && paginationDetails ? /* @__PURE__ */ jsx("div", { className: "border-t border-gray-200", children: /* @__PURE__ */ jsx(
      PaginationComponent,
      {
        paginationDetails,
        capturePageNum,
...
export { Calendar as C, Select as S, Textarea as T, SelectTrigger as a, SelectValue as b, SelectContent as c, SelectItem as d, TanStackTable as e };
//# sourceMappingURL=calendar-Dh1ccXnm.mjs.map
